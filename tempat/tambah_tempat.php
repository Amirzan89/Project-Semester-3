              ...
              <div class="card-body"> <br>
                <form action="/web/tempat/tempat.php" method="POST" class="row" enctype="multipart/form-data">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="row mb-3">
                      <div class="col-sm-12">
                        <input type="text" name="phone" class="form-control" placeholder="Masukkan Nama Pengelola">
                      </div>
                    </div>
                    <label for="inputText"><strong>No. Telpon Pengelola</strong></label>
                    <div class="row mb-3">
                      <div class="col-sm-12">
                        <input type="text" name="phone" class="form-control" placeholder="Masukkan Nomor Telpon Pengelola">
                      </div>
                    </div>
