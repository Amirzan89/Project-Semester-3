    ...
    <header id="header" class="fixed-top ">
        <div class="container d-flex align-items-center">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    <li><a class="nav-link scrollto active" href="LandingPage.php">Beranda</a></li>
                    <li><a class="nav-link scrollto" href="#event">Event</a></li>
                    <li><a class="nav-link scrollto" href="LandingPage.php">Informasi</a></li>
                    <li><a class="nav-link scrollto" href="LandingPage.php">Layanan</a></li>
                    <li><a class="nav-link   scrollto" href="LandingPage.php">Profil</a></li>
