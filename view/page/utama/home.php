            ...
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1"
                    ...
                    <h2>Selamat datang di situs web DISPORABUDPAR Kabupaten Nganjuk!
                        ...
                        Kami telah mengembangkan aplikasi SmartCity untuk meningkatkan efisiensi dan kecepatan pelayanan
                        kepada
                        masyarakat,
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 pt-4 pt-lg-0 content" data-aos="fade-left" data-aos-delay="100">
                        ...
                        <br>
                        <p class="fst-italic">
                            smartCity merupakan sebuah platform aplikasi berbasis mobile yang terintegrasi dengan
                            website, berfungsi
                            sebagai
                            platform untuk mengakses dan memanfaatkan layanan yang dikelola oleh Dinas Kepemudaan,
                            Olahraga,
                            Kebudayaan, dan Pariwisata Kabupaten Nganjuk dengan lebih efisien.
                            Melalui aplikasi ini, masyarakat dapat mengajukan pelayanan secara online, menggantikan
                            proses manual yang
                            sebelumnya dilakukan di kantor dinas.
                            Tujuan utama aplikasi ini adalah untuk memfasilitasi kolaborasi antara petugas dinas dan
                            masyarakat,
        ...
        <section id="event" class="about">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row content">
                    ...
                    <a href="event-details.html" class="btn-learn-more">Lainnya</a>
        ...
        <section id="about" class="portfolio">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    ...
                    <p>Gedung dan Tempat Wisata Yang dikelola oleh Dinas Kepemudaan, Olahraga, Kebudayaan dan Pariwisata
                        Kab.
                        Nganjuk</p>
                </div>
      ...
      <li data-filter=".filter-web">Web</li>
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-img"><img src="/public/assets/img/LandingPage/gedung1.png" class="img-fluid"
                                alt=""></div>
                        <div class="portfolio-info">
                            <h4>Museum Anjuk Ladang</h4>
                            <p>Tempat Wisata</p>
                            <a href="/public/assets/img/LandingPage/gedung1.png" data-gallery="portfolioGallery"
                                class="portfolio-lightbox preview-link" title="Museum Anjuk Ladang"><i
                                    class="bx bx-plus"></i></a>
                            <a href="tempat-details.html" class="details-link" title="Selengkapnya"><i
                                    class="bx bx-link"></i></a>
                        </div>
                    </div>

                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        <div class="portfolio-img"><img src="/public/assets/img/LandingPage/gedung2.png" class="img-fluid"
                                alt=""></div>
                        <div class="portfolio-info">
                            <h4>Balai Budaya</h4>
                            <p>Gedung</p>
                            <a href="/public/assets/img/LandingPage/gedung2.png" data-gallery="portfolioGallery"
                                class="portfolio-lightbox preview-link" title="Balai Budaya"><i
                                    class="bx bx-plus"></i></a>
                            <a href="tempat-details.html" class="details-link" title="Selengkapnya"><i
                                    class="bx bx-link"></i></a>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-img"><img src="/public/assets/img/LandingPage/gedung3.png" class="img-fluid"
                                alt=""></div>
                        <div class="portfolio-info">
                            <h4>Museum Dr. Soetomo</h4>
                            <p>Tempat Wisata</p>
                            <a href="/public/assets/img/LandingPage/gedung3.png" data-gallery="portfolioGallery"
                                class="portfolio-lightbox preview-link" title="Museum Dr. Soetomo"><i
                                    class="bx bx-plus"></i></a>
                            <a href="tempat-details.html" class="details-link" title="Selengkapnya"><i
                                    class="bx bx-link"></i></a>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <div class="portfolio-img"><img src="/public/assets/img/LandingPage/gedung4.png" class="img-fluid"
                                alt=""></div>
                        <div class="portfolio-info">
                            <h4>Goa Margo Tresno</h4>
                            <p>Tempat Wisata</p>
                            <a href="/public/assets/img/LandingPage/gedung4.png" data-gallery="portfolioGallery"
                                class="portfolio-lightbox preview-link" title="Air Terjun Sedudo"><i
                                    class="bx bx-plus"></i></a>
                            <a href="tempat-details.html" class="details-link" title="Selengkapnya"><i
                                    class="bx bx-link"></i></a>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        <div class="portfolio-img"><img src="/public/assets/img/LandingPage/gedung5.png" class="img-fluid"
                                alt=""></div>
                        <div class="portfolio-info">
                            <h4>Goa Margo Tresno</h4>
                            <p>Tempat Wisata</p>
                            <a href="/public/assets/img/LandingPage/gedung5.png" data-gallery="portfolioGallery"
                                class="portfolio-lightbox preview-link" title="Goa Margo Tresno"><i
                                    class="bx bx-plus"></i></a>
                            <a href="tempat-details.html" class="details-link" title="Selengkapnya"><i
                                    class="bx bx-link"></i></a>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-img"><img src="/public/assets/img/LandingPage/gedung6.png" class="img-fluid"
                                alt=""></div>
                        <div class="portfolio-info">
                            <h4>Air Terjun Roro Kuning</h4>
                            <p>Tempat Wisata</p>
                            <a href="/public/assets/img/LandingPage/gedung6.png" data-gallery="portfolioGallery"
                                class="portfolio-lightbox preview-link" title="Air Terjun Roro Kuning"><i
                                    class="bx bx-plus"></i></a>
                            <a href="tempat-details.html" class="details-link" title="Selengkapnya"><i
                                    class="bx bx-link"></i></a>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="100">
                            <div class="pic"><img src="/public/assets/img/LandingPage/layanan1.png" class="img-fluid" alt="">
                            </div>
                    ...
                    <div class="col-lg-6 mt-4 mt-lg-0">
                        <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="200">
                            <div class="pic"><img src="/public/assets/img/LandingPage/layanan2.png" class="img-fluid" alt="">
                            </div>
                            <div class="member-info">
                                <h4>Peminjaman Gedung/Tempat</h4>
                                <p>Masyarakat dapat mengajukan peminjaman gedung dan tempat wisata yang dikelola oleh
                                    DISPARPORABUD.
                                </p>
                                <br>
                                <div>
                    ...
                    <div class="col-lg-6 mt-4">
                        <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="300">
                            <div class="pic"><img src="/public/assets/img/LandingPage/layanan3.png" class="img-fluid" alt="">
                            </div>
                            <div class="member-info">
                                <h4>Nomer Induk Seniman</h4>
                                <p>Masyarakat dapat mendaftarkan nomer induk seniman dan memperpanjang masa berlaku
                                    kartu.</p>
                                <br>
                                <div>
                                    <a href="#" class="btn-baca">Baca Selengkapnya</a>
                    ...
                    <div class="col-lg-6 mt-4">
                        <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="400">
                            <div class="pic"><img src="/public/assets/img/LandingPage/layanan4.png" class="img-fluid" alt="">
                            </div>
                            <div class="member-info">
