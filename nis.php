              ...
              <div class="card success-card revenue-card">
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-1">
                      <h5 class="card-title"><a href="formulir-baru.php">Formulir</a></h5>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card success-card revenue-card">
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-1">
                      <h5 class="card-title"><a href="verif.php">Verifikasi Pengajuan</a></h5>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card success-card revenue-card">
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-1">
                      <h5 class="card-title"><a href="riwayat.php">Riwayat Pengajuan</a></h5>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card success-card revenue-card">
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-1">
                      <h5 class="card-title"><a href="data-seniman.php">Data Seniman</a></h5>
                    </div>
                  </div>
                </div>
              </div>
