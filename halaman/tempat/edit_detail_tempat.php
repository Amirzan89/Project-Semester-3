    ...
    <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/halaman/tempat/detail_tempat.php?id_tempat=<?php $id;?>">Detail tempat</a></li>
                            ...
                            <form method="POST" action="/web/tempat/tempat.php" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3 justify-content-end">
                                    <div class="col-sm-10 text-end">
                                        ...
                                        <a href="/halaman/tempat/detail_tempat.php?id_tempat=<?= $id ?>" class="btn btn-danger">Batal</a>
                                    </div>
                                </div>
                            </form>
                        </div>
