            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <?php if ($seniman['status'] == 'diajukan' || $seniman['status'] == 'proses') { ?>
                        <li class="breadcrumb-item"><a href="/halaman/seniman/pengajuan.php">Pengajuan Nomer Induk
                                Seniman</a></li>
                    <?php } else if ($seniman['status'] == 'diterima' || $seniman['status'] == 'ditolak') { ?>
                            <li class="breadcrumb-item"><a href="/halaman/seniman/riwayat.php">Riwayat Nomer Induk Seniman</a>
                            </li>
                    <?php } ?>
