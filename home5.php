    ...
    <section>
      <div class="container">
        <div class="section-title">
          <br>
          <h1>LAYANAN PEMINJAMAN TEMPAT</h1>
          <p>
    ...
    <section id="why-us" class="why-us section-bg">
        <div class="container-fluid" data-aos="fade-up">
          ...
          <div class="row">
                ...
                <div class="col-lg-12 pt-4 pt-lg-0 content" data-aos="fade-left" data-aos-delay="100">
                  <p class="fst-italic">
                    <ol>
                      ...
                      <li> Ruangan atau tempat yang dipinjam untuk kegiatan harus dijaga dan dipelihara sebaik-baiknya.</li>
                    </ol>
                  </p>
                </div>
              </div>
            ...
            <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img" style='background-image: url("/public/assets/img/LandingPage/hero4.png");' data-aos="zoom-in" data-aos-delay="150">&nbsp;</div>
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 d-flex align-items-center" data-aos="fade-right" data-aos-delay="100">
            <img src="/public/assets/img/LandingPage/prosedur.png" class="img-fluid" alt="">
          </div>
