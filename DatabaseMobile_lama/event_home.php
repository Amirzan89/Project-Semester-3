...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $sql = "SELECT  d.id_detail, d.nama_event, d.tanggal_awal, d.tempat_event, d.poster_event  FROM `events` AS e  JOIN detail_events AS d ON e.id_detail = d.id_detail WHERE status = 'diterima' ORDER BY ABS(TIMESTAMPDIFF(SECOND, NOW(), tanggal_awal)) ASC LIMIT 5";
